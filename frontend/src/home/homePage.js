...
export default function HomePage() {
    return <div className="text-page-container">
        ...
        <Cell title = "Blorbopedia" description = "Submit and view roleplay characters to create wiki-like entries for them! Useful for roleplaying communities to make surface level biographies that are quick to access from discord itself, or to browse through here on this very website! (coming soon)" list = {["Additional roleplay features to come, probably!"]} image={roleplayImg} left = {false}/>
        <Cell title = "All The Other Stuff" description = "Be subjected to a myriad of bizarre features that exist solely to satiate my own whimsy!" list = {["Shitposts that trigger on keywords (You can turn it off)", "Commands for reaction images", "Jokes, fun facts, and inspirational quotes"]} image = {otherImg} left = {true}/>
    </div>
}